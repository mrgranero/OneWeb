...
<ul class="breadcrumb <?php echo $moduleclass_sfx; ?>">
	...
	if ($key != $last_item_key)
	{
		...
		// Seth - D'uh, if I want a seperator, I'll do it with CSS not junk markup.
		echo '<li>';
		if (!empty($item->link))
		{
		...
		// Seems silly to render this element, CSS would be preferable. See _pagination.scss instead.
